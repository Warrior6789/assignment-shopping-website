 ...
 * @author philo
 */
public class ViewCreatePageServlet extends HttpServlet {

    private final String createPage = "CreatePage.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Categories> listCate = categoryDao.getAll();
            request.setAttribute("supList", listSup);
             request.setAttribute("cateList", listCate);
        } catch (Exception e) {
            System.out.println("error: "+e.getMessage());
        }finally{
            System.out.println("url loginservlet: "+url);
